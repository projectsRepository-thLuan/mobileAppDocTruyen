...
public class adapterTruyen extends RecyclerView.Adapter<adapterTruyen.ViewHolder> {
    ...
    public adapterTruyen(Context context, List<Truyen> listTruyen) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.get().load(config.BASE_URL +truyen.getAnh()).placeholder(R.drawable.ic_load).error(R.drawable.ic_image).into(holder.imgtruyen);
